export enum Errors {
    ...
    PROJECT_BLOCKCHAIN_SETUP_ALREADY_EXISTS = 'PROJECT_BLOCKCHAIN_SETUP_ALREADY_EXISTS',
    NOT_AVAILABLE_FOR_VIEW = 'NOT_AVAILABLE_FOR_VIEW',
    WEBHOOK_ALREADY_EXISTS = 'WEBHOOK_ALREADY_EXISTS',
    BLOCK_RECHECK_ALREADY_EXISTS = 'BLOCK_RECHECK_ALREADY_EXISTS',
    SUBSCRIPTION_BLOCK_RECHECK_ALREADY_EXISTS = 'SUBSCRIPTION_BLOCK_RECHECK_ALREADY_EXISTS',
}
