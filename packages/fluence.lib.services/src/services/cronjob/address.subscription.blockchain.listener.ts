import { Block, Hashtable, PluginManager, Recipient, Transaction } from '@applicature-private/core.plugin-manager';
...
export class AddressSubscriptionBlockChainListener extends BlockchainListener {
    ...
    constructor(
        ...
        this.subscriptionService = pluginManager.getServiceByClass(
