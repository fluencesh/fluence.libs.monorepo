...
const CompatibleBitcoinTxMiningListener = require('./src/jobs/btc.tx.mining.listener');
const CompatibleBitcoinTransactionSender = require('./src/jobs/btc.tx.sender');
