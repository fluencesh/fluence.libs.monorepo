declare module 'web3' {
    ...
    namespace Web3 {
        ...
        export interface Utils {
            BN: BigNumber.BigNumber; // TODO only static-definition
            ...
            numberToHex(val: number | BigNumber.BigNumber): string;
            checkAddressChecksum(address: string): boolean;
            fromAscii(val: string): string;
            fromDecimal(val: string | number | BigNumber.BigNumber): string;
            fromUtf8(val: string): string;
            fromWei(val: string | number | BigNumber.BigNumber, unit: Unit): string | BigNumber.BigNumber;
            hexToBytes(val: string): number[];
            hexToNumber(val: string | number | BigNumber.BigNumber): number;
            hexToNumberString(val: string | number | BigNumber.BigNumber): string;
            ...
            toBN(any: any): BigNumber.BigNumber;
            toChecksumAddress(val: string): string;
            toDecimal(val: any): number;
            toHex(val: any): string;
            toUtf8(val: any): string;
            toWei(val: string | number | BigNumber.BigNumber, unit: Unit): string | BigNumber.BigNumber;
            unitMap: any;
        }
    }
    /* tslint:disable */
